...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DeltaPhiPt@pt@_cfi.py nevts:100'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('DeltaPhiGun.root'),
...
process.generator = cms.EDProducer("DeltaPhiGunProducer",
    PGunParameters = cms.PSet(
        ...
        MinDeltaPhi = cms.double(@dPhi_min@),
        MaxDeltaPhi = cms.double(@dPhi_max@),
        ParticleMinEta = cms.double(-0.8),
        ParticleMaxEta = cms.double(0.8),
        ParticleMinPhi = cms.double(-3.14159265359),
        ParticleMaxPhi = cms.double(3.14159265359)
    ),
