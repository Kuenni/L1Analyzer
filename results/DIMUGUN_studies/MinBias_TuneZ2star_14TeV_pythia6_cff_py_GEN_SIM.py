...
# with command line options: Configuration/GenProduction/python/FourteenTeV/MinBias_TuneZ2star_14TeV_pythia6_cff.py --step GEN,SIM --geometry Extended2017 --beamspot Gauss --conditions auto:upgrade2017 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2017 --eventcontent FEVTDEBUG --datatier GEN-SIM -n 1000 --no_exec
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2star_14TeV_pythia6_cff_py_GEN_SIM.root'),
