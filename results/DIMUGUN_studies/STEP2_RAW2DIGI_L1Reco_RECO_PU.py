...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO --geometry Extended2017 --conditions auto:upgrade2017 --pileup AVE_140_BX_25ns --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2017 --eventcontent FEVTDEBUG --datatier GEN-SIM-RECO --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/user/erdogan/eventgen/REDIGI_DIGI_L1_DIGI2RAW_PU.root')
)
