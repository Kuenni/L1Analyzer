...
# with command line options: SingleMuPt10_cfi.py -s GEN,SIM,DIGI --conditions=START62_V1::All --eventcontent=FEVTDEBUG -n 10 --no_exec --mc
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuPt10_cfi_py_GEN_SIM_DIGI.root'),
