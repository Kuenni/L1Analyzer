...
# with command line options: SingleMuPt1_cfi.py -s GEN,SIM,DIGI --conditions=START62_V1::All --eventcontent=FEVTDEBUG -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SingleMuPt1_cfi.py nevts:10'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuPt1_cfi_py_GEN_SIM_DIGI.root'),
